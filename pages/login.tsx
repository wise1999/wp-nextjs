        ...
        <div className="px-4 py-20 mx-auto max-w-7xl">
          ...
          >
            ...
            <FormProvider {...methods}>
              <form className="pb-1 space-y-4" onSubmit={handleSubmit(onSubmitHandler)} action="/api/auth/callback/credentials">
                ...
                <div className="flex items-center justify-between">
                  <button className="btn btn-primary mx-auto" disabled={isSubmitting} type="submit">Sign In</button>
                </div>
              </form>
          ...
          <p className="mb-4 space-y-2 text-sm text-left text-gray-600 sm:text-center sm:space-y-0">
            <Link href="/register" className="w-full btn btn-sm btn-link sm:w-auto">Don't have an account yet? Sign Up</Link>
          </p>
        </div>
      </section>
    </>
